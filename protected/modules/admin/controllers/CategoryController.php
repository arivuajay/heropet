...
class CategoryController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Category'])) {
            ...
            if ($model->save()) {
                if (!empty($uploadedFile)) {
                    $uploadedFile->saveAs(Yii::app()->basePath . '/../uploads/pet_category/' . $fileName);
                }
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['Category'])) {
            ...
            $_POST['Category']['category_image'] = $model->category_image;
            $model->attributes = $_POST['Category'];

            $uploadedFile = CUploadedFile::getInstance($model, 'category_image');
            if (!empty($uploadedFile)) {
                if ($model->category_image) {
                    $file = Yii::getPathOfAlias('webroot') . '/uploads/pet_category/' . $model->category_image;
                    if (file_exists($file)) {
                        unlink($file);
                    }
                }
