        ...
        <form class="jqtransform">
            <div class="row"> 
                <div class="col-xs-12 col-sm-6 col-md-3 search-fileds">  
                    <img src="<?php echo $this->themeUrl;?>/img/map-icon.png" alt=""> 
                    <input name="" type="text" class="map-field" value="PLZ oder Ort eingeben"> 
                </div>
                <div class="col-xs-12 col-sm-6 col-md-3 search-fileds">  
                    <img src="<?php echo $this->themeUrl;?>/img/filter-icon.png" alt=""> 
                    <label>With in :</label>
                    <select name="select">
                ...
                </div><div class="col-xs-12 col-sm-6 col-md-3 search-fileds">
                    <label>Breed :</label>
                    <select name="select">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-3"> 
            <div class="search-result-thumb-cont"> 
                ...
                <a href="#">
                    <?php echo CHtml::image($this->themeUrl.'/img/dog.jpg', 'DORE', array('class' => 'img-responsive')); ?>
                </a>
            </div>
            <div class="dog-deatils"> 
                <div class="dog-details-row">
                    <div class="details-icon"> <?php echo CHtml::image($this->themeUrl.'/img/reward-icon.png', 'reward'); ?> </div>
                    <div class="details-txt"> REWARD: 1500 €  </div>                        
                </div>

                <div class="dog-details-row">
                    <div class="details-icon"> <?php echo CHtml::image($this->themeUrl.'/img/phone.png', 'reward'); ?> </div>
                    <div class="details-txt"> +49 82131 123456 </div>                        
                </div>

                <div class="dog-details-row">
                    <div class="details-icon"> <?php echo CHtml::image($this->themeUrl.'/img/map-icon2.png', 'map'); ?> </div>
                    <div class="details-txt"> München | DE <br/>
                        15:24   14.März 2015</div>               
                    <div class="small-logo"> <?php echo CHtml::image($this->themeUrl.'/img/small-logo.png', 'logo'); ?></div>         
                </div>
            </div>
        </div>
