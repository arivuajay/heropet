                        ...
                        <div class="box-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php
                                    if (!empty($user_profile->user_profile_picture)) {
                                        echo CHtml::image(Yii::app()->request->baseUrl . '/uploads/pet_user_profile/' . $user_profile->user_profile_picture, $user_profile->user_profile_picture, array('width' => 100, 'height' => 100));
                                    }
                                    ?>
