...
class CmsContent extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('heading, body, url, pageTitle,','required'),
             array(
            'url',
            'match', 'not' => true, 'pattern' => '/[^a-zA-Z0-9_-]/',
            'message' => 'Url can contain only alphanumeric characters and hyphens(-)..',
        ),
            array('heading, url, pageTitle, metaTitle, metaDescription, metaKeywords', 'length', 'max' => 255),
            array('metaTitle,metaDescription,metaKeywords', 'safe'),
